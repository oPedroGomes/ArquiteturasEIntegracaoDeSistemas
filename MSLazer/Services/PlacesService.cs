...
namespace MSLazer.Services
{
    public class PlacesService
    {
        ...
        public PlacesService(IHttpClientFactory httpFactory,IConfiguration configuration) 
        {
            _httpFactory = httpFactory;
            _configuration = configuration;
        }
        public async Task<PlacesResponseLazer> GetDirectionsByCoordinates(SearchParametersLazer SearchParameters)
        {
            ...
            try
            {
                ...
                var response = JsonConvert.DeserializeObject<PlacesResponseLazer>(content);
                return response;
